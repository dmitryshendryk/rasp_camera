    ...
    def upload_video_to_server(self,mqttc, obj, msg):
        ...
        def upload(self, mqttc, obj, msg):
            ...
            if self.rpi_id == msg['rpi_id']['rpis'] and self.local_config['type'] == msg['type'] and self.local_config['location'] == msg['rpi_id']['region']: 
                ...
                mqttc.mqtt.publish_message('/logs/rpi/' + self.local_config['type'] + '/', blob)
                ...
                try:
                    ...
                    blob = json.dumps(blob)
                    mqttc.mqtt.publish_message("/camera/uploading/" + self.config._configuration_data['type'] +  '/' + self.config._configuration_data['location'] + '/' + str(rpi_id), blob)
